...
window.onload = function() {
    ...
    //     // const a = $(".js-count-input").val();
    //     // console.log($('#price').text());
    //     console.log($('#amount').val());
    //     // const sum = parseInt($('#price').text()) * $('#amount').val();
    //     // console.log(sum);
...
// 	const passField = document.querySelector(".showPass");
// 	const showBtn = document.querySelector(".showPass i");
// 	showBtn.onclick = (() => {
